    ...
    <div class="slider">
        <div class="callbacks_container">
            <ul class="rslides" id="slider">
                <li><img src="{{ url('images/banner.jpg') }}" class="img-responsive" alt=""/>
                    <div class="button">
                        <a href="https://www.youtube.com/watch?v=G4VmJcZR0Yg" class="hvr-shutter-out-horizontal" target="_blank">Ver Trailer!</a>
                    </div>
                </li>
                <li><img src="{{ url('images/banner1.jpg') }}" class="img-responsive" alt=""/>
                    <div class="button">
                        <a href="https://www.youtube.com/watch?v=B74fg6OY1aE" class="hvr-shutter-out-horizontal" target="_blank">Ver Trailer!</a>
                    </div>
                </li>
                <li><img src="{{ url('images/banner2.jpg') }}" class="img-responsive" alt=""/>
                    <div class="button">
                        <a href="https://www.youtube.com/watch?v=e3Nl_TCQXuw" class="hvr-shutter-out-horizontal" target="_blank">Ver Trailer!</a>
                    </div>
                </li>
            </ul>
        </div>
